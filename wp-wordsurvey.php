...
function wordsurvey_menu() {
	add_menu_page( __( 'WordSurvey', 'wp-wordsurvey' ), __( 'WordSurvey', 'wp-wordsurvey' ), 'manage_options', 'wp-wordsurvey/wordsurvey-manager.php', '', 'dashicons-chart-pie' );
	add_submenu_page( 'wp-wordsurvey/wordsurvey-manager.php', __( 'Add Survey', 'wp-wordsurvey'), __( 'Add Survey', 'wp-wordsurvey' ), 'manage_options', 'wp-wordsurvey/wordsurvey-add.php' );
}

//SCRIPT ADMIN
add_action('admin_enqueue_scripts', 'wordsurvey_register_script');
function wordsurvey_register_script($hook){
	if ( 'wp-wordsurvey/wordsurvey-manager.php' != $hook && 'wp-wordsurvey/wordsurvey-add.php' != $hook ) {
        return;
    }
	...
	'Add_Answer'  => __('Aggiungi Risposta','wp-wordsurvey'),
	'Question' => __( 'Domanda', 'wp-wordsurvey' ),
	'Save_Question' => __( 'Salva Domanda', 'wp-wordsurvey' ),
	'Type' => __( 'Tipologia', 'wp-wordsurvey' ),
	'Obligatory_Question' => __( 'Domanda Obbligatoria', 'wp-wordsurvey' ),
	'text' => __( 'testo', 'wp-wordsurvey' ),
	'select' => __( 'seleziona...', 'wp-wordsurvey' ),
	'selection' => __( 'selezione', 'wp-wordsurvey' ),
	'Reply' => __( 'Risposta', 'wp-wordsurvey' ),
	'Reply_n_1' => __( 'Risposta n. 1', 'wp-wordsurvey' ),
	'Number_of_reply' => __( 'Numero di risposte', 'wp-wordsurvey' ),
	'Edit_Sounding' => __( 'Modifica Sondaggio', 'wp-wordsurvey' ),
	'Delete_Sounding' => __( 'Elimina Sondaggio', 'wp-wordsurvey' ),
	'Edit_Question' => __( 'Modifica Domanda', 'wp-wordsurvey' ),
	'Delete_Question' => __( 'Elimina Domanda', 'wp-wordsurvey' ),
	'Create_Sounding' => __( 'Crea Sondaggio', 'wp-wordsurvey' ),
	) );
...
function wordsurvey_tinymce_translation($mce_translation) {
	$mce_translation['Enter ID'] = esc_js(__('Enter ID', 'wp-sounding'));
	$mce_translation['Error: ID must be numeric'] = esc_js(__('Error: ID must be numeric', 'wp-wordsurvey'));
	$mce_translation['Please enter ID again'] = esc_js(__('Please enter ID again', 'wp-wordsurvey'));
	$mce_translation['Insert Survey'] = esc_js(__('Insert Survey', 'wp-wordsurvey'));
