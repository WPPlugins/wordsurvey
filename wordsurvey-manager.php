...
?>
<div class="banner_pro" style="margin-left:-40px !important;"><a href="http://www.sersis.com/wordsurvey/" target="_blank"><img src="<?php echo plugins_url( 'images/banner_pro.jpg', __FILE__ ); ?>"></a></div>
<?php
